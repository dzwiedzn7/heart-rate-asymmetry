...
if __name__ == 'app':
    ...
    returnValue = ListBoxChoice(root, "Plotter", "Choose plot you want", ['HR/time','Speed/time','Pace/time',
                                'Cadence/time','Altitude/time','Temperature/time','ALL'])#.returnValue()
    z = returnValue.returnValue()
    root.destroy()
        #print returnValue
