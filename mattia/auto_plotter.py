...
def plot_all(t,s,hr,pace,name):
    ...
    ax.plot_date(t,hr/max(hr),'b-',label = 'HR',color='green')
    plt.plot_date(t, s/max(s),fmt='b-', tz=None, xdate=True,
...
folders = glob.glob('#*')
choice = raw_input("Choose a variable [HR,speed,pace,ALL]: ")
for directory in folders:
    get_data = str(directory.split('#')[-1] + '.csv')
